...
ChatCommand* ChatHandler::getCommandTable()
{
    ...
    static ChatCommand reloadCommandTable[] =
    {
		...
		{ "item_template",               SEC_ADMINISTRATOR, true,  &ChatHandler::HandleReloadItemTemplateCommand,            "", nullptr },
		{ "gameobject_template",         SEC_ADMINISTRATOR, true,  &ChatHandler::HandleReloadGameobjectTemplateCommand,      "", nullptr },
		{ "instance_template",           SEC_ADMINISTRATOR, true,  &ChatHandler::HandleReloadInstanceTemplateCommand,        "", nullptr },
...
=======
	static ChatCommand commandTable[] =
	{
		...
		{ "quit",           SEC_CONSOLE,        true,  &ChatHandler::HandleQuitCommand,                "", nullptr },
		{ "mmap",           SEC_GAMEMASTER,     false, nullptr,                                        "", mmapCommandTable },
		{ "chat",			    SEC_PLAYER,         false,  &ChatHandler::HandleWorldChatCommand,           "", nullptr },
>>>>>>> master
